...
export type ProjectRepository = ReturnType<typeof makePrismaProjectRepository>;

export function makePrismaProjectRepository(client: PrismaClient) {
  return new (class ProjectRepository {
    findById(id: string) {
