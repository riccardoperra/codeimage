...
import {Box, FadeInOutTransition, themeVars} from '@codeimage/ui';
...
import {TerminalReflection} from './TerminalReflection';
...
export const TerminalHost: Component<TerminalHostProps> = props => {
  return (
    ...
    >
      <FadeInOutTransition show={props.showReflection}>
        <TerminalReflection />
      </FadeInOutTransition>
